...
parser.add_argument('--batch_size', type=int, default=6, help='testing batch size')
parser.add_argument('--numdepth', type=int, default=192, help='the number of depth values')

parser.add_argument('--loadckpt', default='checkpoints/debug/model_000005.ckpt', help='load a specific checkpoint')
parser.add_argument('--outdir', default='./outputs07', help='output dir')
